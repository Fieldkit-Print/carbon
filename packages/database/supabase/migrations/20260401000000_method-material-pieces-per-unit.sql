-- Add piecesPerUnit to methodMaterial and jobMaterial for n-up imposition support.
-- This allows item master templates to define imposition, which carries through
-- to quotes and jobs via "Get Method".
...
-- Update get_method_tree to include piecesPerUnit
...
WITH RECURSIVE material AS (
    SELECT
        ...
        COALESCE(
            ...
            CASE WHEN "methodType" = 'Pick' THEN (
    ...
    SELECT
        ...
        COALESCE(
            ...
            CASE WHEN child."methodType" = 'Pick' THEN (
        ...
        child."kit",
        child."shelfIds",
        (parent."methodType" = 'Pick' OR parent."isPickDescendant") AS "isPickDescendant",
        child."piecesPerUnit"
    FROM
