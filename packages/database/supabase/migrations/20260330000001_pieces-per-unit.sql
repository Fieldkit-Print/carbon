-- Add piecesPerUnit to quoteMaterial for n-up imposition support.
-- A value of 6 means each unit of this material produces 6 finished pieces
...
-- Update get_quote_methods to include piecesPerUnit
